 ...
 * @author greg
 */
public class AboutScreen extends AbstractLevel
{
    private Button playButton = new Button(200, 80);
    
    /**
     * Constructor with Level Manager parameter
     * @param lm
     */
    public AboutScreen(LevelManager lm)
    {
    ...
    public void draw(Graphics2D g) 
    {
        ...
        g.drawString("About Screen", 200, 40);
